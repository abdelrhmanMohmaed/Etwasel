...
@section('content')
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="formItemVendor">
                                                        <span>{{ __('front.PMC') }}
                                                            ...
                                                            <a class="btnInfoPopover" data-toggle="popover"
                                                                data-trigger="hover"
                                                                data-content="{{ $website->pmc_info ?? '' }}"><i
                                                                    class="fas fa-info"></i> </a>
                                                        </span>
                                                        <select id='pmc_id' name='pmc_id' class='form-control select2'
                                                            required>
                                                            @if (count($user->pmcs) > 0)
                                                                @foreach ($user->pmcs as $pmc)
                                                                    <option value='{{ $pmc->id }}'
                                                                        @if ($product->pmc_id == $pmc->id) selected @endif>
                                                                        {{ $pmc->cat_name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="col-lg-12 col-nd-12 col-sm-12 col-xs-12">
                                                    <div class="formItemVendor">
                                                        ...
                                                        <textarea placeholder="" id='product_name_en' name='product_name_en' value='' required
                                                            class="TextInputt">{{ $product->product_name_en }}</textarea>
                                                ...
                                                <div class="col-lg-12 col-nd-12 col-sm-12 col-xs-12">
                                                    <div class="formItemVendor">
                                                        ...
                                                        <textarea placeholder="" id='product_name_ar' name='product_name_ar' value='' required
                                                            class="TextInputt">{{ $product->product_name_ar }}</textarea>
                                                        ...
                                                        <div class="setingstaps">
                                                            ...
                                                            <div class="TapCOnfirmation">
                                                                <ul class="nav nav-tabs nav-tabs-custom nav-justified"
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" data-bs-toggle="tab"
                                                                            ...
                                                                            <span
                                                                                class=" d-sm-block">{{ __('front.Product Pictures') }}</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-bs-toggle="tab"
                                                                            ...
                                                                            <span
                                                                                class=" d-sm-block">{{ __('front.Product Video') }}</span>
                                                                        </a>
                                                                    </li>
                                                                ...
                                                                <div class="tab-content p-3 text-muted bs-example">
                                                                    <div class="tab-pane active tab-content" id="Phone"
                                                                        role="tabpanel">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="qoutstepform ">
                                                                                            ...
                                                                                            <div
                                                                                                class="input-group image-preview fileuploaaad">
                                                                                                <input type="text"
                                                                                    ...
                                                                                    <div class="row"
                                                                                        ...
                                                                                        @if ($product->media)
                                                                                            @foreach ($product->media as $media)
                                                                                                @if ($media->type == 'image')
                                                                                                    <div
                                                                                                        class="col-lg-3 col-md-3 col-sm-12 col-xs-12 weyy">
                                                                                                        <div
                                                                                                            class="formItemVendor">
                                                                                                            <a href="{{ Voyager::image($media->image) }}"
                                                                                                                class="Itemmm">
                                                                                                                <div
                                                                                                                    class="sliderimgItem">
                                                                                                                    <img
                                                                                                                    ...
                                                                                                                    <button
                                                                                                                        type="button"
                                                                                                                        data-id='{{ $media->id }}'
                                                                                                                        class="Removee RemoveSlide RemoveProductImage">
                                                                                                                        <i
                                                                    ...
                                                                    <div class="tab-pane tab-content" id="Email"
                                                                        role="tabpanel">
                                                                        <div class="tabcontent-grids">
                                                                            <div class="setforms">
                                                                                <div class="row">
                                                                                                ...
                                                                                                <span
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input type="file"
                                                                                                            ...
                                                                                                            id='video'
                                                                                                            name='video[]'
                                                                                                            onchange="changeVideoPreview(event);" />
                                                                                                    </div>
                                                                                                </span>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <div class="row sliderimgItemV">
                                                                                    @if ($product->media)
                                                                                        @foreach ($product->media as $media)
                                                                                            @if ($media->type == 'video')
                                                                                                <div
                                                                                                    class="col-lg-4 col-md-4 col-sm-6 col-xs-12 weyy">
                                                            ...
                                                            <div style='display:none' class="bs-example bs-example-tabs"
                                                                ...
                                                                <ul id="myTab" class="nav nav-tabs" role="tablist">
                                                                    <li role="presentation" class="active">
                                                                        <a href="#home" id="home-tab" role="tab"
                                                                            ...
                                                                            aria-expanded="true"
                                                                            class="active show">{{ __('front.Product Pictures') }}</a>
                                                                    </li>
                                                                    <li role="presentation">
                                                                        <a href="#carl" role="tab" id="carl-tab"
                                                                            data-toggle="tab"
                                                                            aria-controls="carl">{{ __('front.Product Video') }}</a>
                                                                    </li>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="formItemVendor">
                                                        ...
                                                        <select id='currency_id' class='form-control select2'
                                                            name='currency_id' required>
                                                            @if ($currencies)
                                                                @foreach ($currencies as $currency)
                                                                    <option value='{{ $currency->id }}'
                                                                        @if ($product->currency_id == $currency->id) selected @endif>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="formItemVendor">
                                                                ...
                                                                <input type="number" step="0.01" id='min_price'
                                                                    name='min_price' value='{{ $product->min_price }}'
                                                                    class="inputvendor" required placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="formItemVendor">
                                                                ...
                                                                <input type="number" step="0.01" id='max_price'
                                                                    name='max_price' value='{{ $product->max_price }}'
                                                                    class="inputvendor" required placeholder="">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-nd-6 col-sm-6 col-xs-12">
                                                    <div class="formItemVendor">
                                                        ...
                                                        <input type="text" id='load_time' name='load_time'
                                                            value='{{ $product->load_time }}' class="inputvendor"
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <textarea placeholder="My Info" id='product_desc' value='' name='product_desc' required
                                                        class="textarea"> {{ $product->product_desc }} </textarea>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="formItemVendor">
                                                    ...
                                                    <textarea placeholder="My Info" id='product_desc_ar' value='' name='product_desc_ar' required
                                                        class="textarea">{{ $product->product_desc_ar }}</textarea>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                    <div>
                                                        <span id='f_error' style="display:none">please select keyword,date
                                                            from and date to</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-nd-3 col-sm-3 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    <span>{{ __('front.1st_page') }}
                                                                        ...
                                                                        <a class="btnInfoPopover" data-toggle="popover"
                                                                            data-trigger="hover"
                                                                            data-content="{{ $website->first_keyword_info }}"><i
                                                                                class="fas fa-info"></i> </a>
                                                                    </span>


                                                                    <input id='first_page_keywrd_input'
                                                                        class="form-control " type="text" value=""
                                                                        list="first_page_keywrd_list"
                                                                        name='first_page_keywrd_list' />
                                                                    <datalist id='first_page_keywrd_list'>
                                                                        @if ($first_page_keywrds)
                                                                            @foreach ($first_page_keywrds as $f_keyword)
                                                                                <option value='{{ $f_keyword->keyword }}'
                                                                                    data-price="{{ $f_keyword->price }}">
                                                                                </option>
                                                                            @endforeach
                                                                        @endif
                                                                    </datalist>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="formItemVendor">
                                                                            ...
                                                                            <div class="input-group" id="datepicker3">
                                                                                <input type="date" name='first_page_from'
                                                                                    class="form-control first_page_from_input"
                                                                                ...
                                                                                <span
                                                                                    class="input-group-text bg_Brawen_iconinput"><i
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="formItemVendor">
                                                                            ...
                                                                            <div class="input-group" id="datepicker4">
                                                                                <input type="date" name='first_page_to'
                                                                                    class="form-control first_page_to_input"
                                                                                    placeholder="dd M, yyyy"
                                                                                    data-date-format="dd M, yyyy"
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pp">
                                                                <div class="formItemVendor">
                                                                    ...
                                                                    <input readonly type="text" id='first_page_price_input'
                                                                        name='first_page_price'
                                                                        class="inputvendor first_page_price"
                                                                        placeholder="">
                                                                    <input type="hidden" id="f_page_position"
                                                                        name="f_page_position" value="first_page">
                                                            ...
                                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    <button style="top: 35px; " type="button"
                                                                        class="addMore addMore_input"
                                                ...
                                                <div class="keyword_table">
                                                    <table id="keywordstable" class="table table-bordered"
                                                        style='display:@if (empty($first_page_keywords)) none @endif'>
                                                        <thead>
                                                                ...
                                                                @foreach ($first_page_keywords as $keyword)
                                                                    <tr>
                                                                        ...
                                                                        <td> <button type="button"
                                                                                class="btn btn-danger f_delete2"
                                                                                title="delete"><i
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                    <div>
                                                        ...
                                                        <span id='d_error' style="display:none">please select keyword,date
                                                            from and date to</span>
                                                        <div class="row">
                                                            <div class="col-lg-3 col-nd-3 col-sm-3 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    <span>{{ __('front.Top Dynamic') }}
                                                                        ...
                                                                        <a class="btnInfoPopover" data-toggle="popover"
                                                                            data-trigger="hover"
                                                                            data-content="{{ $website->top_dynamic }}"><i
                                                                                class="fas fa-info"></i> </a>
                                                                    </span>
                                                            ...
                                                            @endif
                                                                    ...
                                                                    <input id='dynamic_page_keywrd_input'
                                                                        class="form-control  "
                                                                        list="dynamic_page_keywrd_list" type="text" value=""
                                                                        name='dynamic_page_keywrd' />
                                                                    <datalist id='dynamic_page_keywrd_list'>
                                                                        @if ($dynamic_page_keywrds)
                                                                            @foreach ($dynamic_page_keywrds as $d_keyword)
                                                                                <option
                                                                                    value='{{ $d_keyword->keyword }}'>
                                                                                </option>
                                                                            @endforeach
                                                                        @endif
                                                                    </datalist>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="formItemVendor">
                                                                            <span>{{ __('front.From') }} </span>
                                                                            <div class="input-group" id="datepicker3">
                                                                                <input type="date" name='dynamic_page_from'
                                                                                    class="form-control dynamic_page_from_input"
                                                                                    placeholder="dd M, yyyy"
                                                                                    data-date-format="dd M, yyyy"
                                                                                    data-date-container='#datepicker3'
                                                                                    data-provide="datepicker"
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="formItemVendor">
                                                                            <span>{{ __('front.TO') }} </span>
                                                                            <div class="input-group" id="datepicker4">
                                                                                <input type="date" name='dynamic_page_to'
                                                                                    class="form-control dynamic_page_to_input"
                                                                                    placeholder="dd M, yyyy"
                                                                                    data-date-format="dd M, yyyy"
                                                                                    data-date-container='#datepicker4'
                                                                                    data-provide="datepicker"
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    <span>{{ __('front.Price') }} </span>
                                                                    <input readonly name='dynamic_page_price'
                                                                        id='dynamic_page_price_input' type="text"
                                                                        class="inputvendor dynamic_page_price_input"
                                                                        placeholder="">
                                                                </div>
                                                                <input type="hidden" id="dynamic_position"
                                                                    name="dynamic_position" value="dynamic_page">
                                                            </div>
                                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    <button style="top: 35px;" type="button"
                                                                        class="addMore add_more" title="Add Mor Emails">
                                                                        <i class="fas fa-plus iconpluss"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="keyword_d_table keyword_table"
                                                            style='display:@if (empty($dynamic_page_keywords)) none @endif'>
                                                                    ...
                                                                    @if (!empty($dynamic_page_keywords))
                                                                        @foreach ($dynamic_page_keywords as $keyword)
                                                                            <tr>
                                                                                ...
                                                                                <td> <button type="button"
                                                                                        class="btn btn-danger d_delete2"
                                                                                        title="delete"><i
                                                                                            class="far fa-trash-alt"></i>
                                                                                    </button></td>
                                                                            </tr>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="formItemVendor">
                                                        <button type="button" class="btn btn-primary"
                                                            ...
                                                            data-bs-target=".bs-example-modal-xl">{{ __('front.first_page_preview') }}</button>

                                                        <button type="button" class="btn btn-primary"
                                                            data-bs-toggle="modal"
                                                            data-bs-target=".ScondPriview">{{ __('front.dynamic_page_preview') }}</button>
                                                    </div>
    ...
    <div class="modal fade bs-example-modal-xl modalprivew" tabindex="-1" role="dialog"
                                                            ...
                                                            <div id='jtv-rev_slider' class='rev_slider fullwidthabanner'>
                                                                <ul>
                                                                    <li data-transition='random' data-slotamount='7'
                                                                        ...
                                                                        data-thumb="{{ asset('frontUI/assets/img/cladreximg/slide-img1.jpg') }}">
                                                                        <img src="{{ asset('frontUI/assets/img/cladreximg/slide-img1.jpg') }}"
                                                                            alt="slide-img" data-bgposition='left top'
                                                                            data-bgfit='cover' data-bgrepeat='no-repeat' />
                                                                        <div class="info">
                                                                            <div class='tp-caption jtv-sub-title sft  tp-resizeme '
                                                                                ...
                                                                                <span>Fashion Hussein 2017</span>
                                                                            </div>
                                                                            <div class='tp-caption jtv-large-title sfl  tp-resizeme '
                                                                                data-endspeed='500' data-speed='500'
                                                                                data-start='1300'
                                                                                data-easing='Linear.easeNone'
                                                                                data-splitin='none' data-splitout='none'
                                                                            ...
                                                                            <div class='tp-caption sfb  tp-resizeme '
                                                                                ...
                                                                                data-endelementdelay='0.1'
                                                                                style='z-index:4;max-width:auto;max-height:auto;white-space:nowrap;'>
                                                                                <a href='#' class="jtv-shop-now-btn">Shop
                                                                                    Now</a>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li data-transition='random' data-slotamount='7'
                                                                        data-masterspeed='1000'
                                                                        data-thumb="{{ asset('frontUI/assets/img/cladreximg/slide-img2.jpg') }}">
                                                                        <img src="{{ asset('frontUI/assets/img/cladreximg/slide-img2.jpg') }}"
                                                                            alt="slide-img" data-bgposition='left top'
                                                                            data-bgfit='cover' data-bgrepeat='no-repeat' />
                                                                        <div class="info">
                                                                            <div class='tp-caption jtv-sub-title sft slide2  tp-resizeme '
                                                                                data-endspeed='500' data-speed='500'
                                                                                data-start='1100'
                                                                                data-easing='Linear.easeNone'
                                                                                data-splitin='none' data-splitout='none'
                                                                            ...
                                                                            <div class='tp-caption Title sft  tp-resizeme '
                                                                                ...
                                                                                data-endelementdelay='0.1'
                                                                                style='z-index:4;max-width:auto;max-height:auto;white-space:nowrap;'>
                                                                                Best offer of the month top brands.</div>
                                                                            <div class='tp-caption sfb  tp-resizeme '
                                                                                data-endspeed='500' data-speed='500'
                                                                                data-start='1500'
                                                                                data-easing='Linear.easeNone'
                                                                                ...
                                                                                data-endelementdelay='0.1'
                                                                                style='z-index:4;max-width:auto;max-height:auto;white-space:nowrap;'>
                                                                                <a href='#' class="jtv-shop-now-btn">View
                                                                                    colletion</a>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li data-transition='random' data-slotamount='7'
                                                                        data-masterspeed='1000'
                                                                        data-thumb="{{ asset('frontUI/assets/img/cladreximg/slide-img3.jpg') }}">
                                                                        <img src="{{ asset('frontUI/assets/img/cladreximg/slide-img3.jpg') }}"
                                                                            alt="slide-img" data-bgposition='left top'
                                                                            data-bgfit='cover' data-bgrepeat='no-repeat' />
                                                                        <div class="info">
                                                                            <div class='tp-caption jtv-sub-title sft slide2  tp-resizeme '
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="addside">
                                            <div class="addcontent">
                                                <img id='f_prev_img'
                                                    src="{{ asset('frontUI/assets/img/cladreximg/media1.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="modal fade bs-example-modal-xl ScondPriview " tabindex="-1" role="dialog"
        aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.addMore_input').click(function() {
                // alert('hi');
                var ids = [];
                if (!$('#first_page_keywrd_input').val() || !$('.first_page_from_input').val() || !$(
                        '.first_page_to_input').val()) {
            ...
            function useNextLoad(total) {
                ...
                $('#keywordstable > tbody').append('<tr><td><p>' + $('#first_page_keywrd_input').val() +
                    '</td><td><p>' + $('.first_page_from_input').val() + '</td><td><p>' + $(
                        '.first_page_to_input').val() + '</td><td><p>' + $('#first_page_price_input').val() +
                    '</td><td><p>' + $('#total').val() + '</p></td><td>  ' +
            ...
            $('.add_more').click(function() {
                // alert('hi');
                var ids = [];
                if (!$('#dynamic_page_keywrd_input').val() || !$('.dynamic_page_from_input').val() || !$(
                        '.dynamic_page_to_input').val()) {
            ...
            function useNextLoad2(total2) {
                ...
                $('#keywords_d_table > tbody').append('<tr><td><p>' + $('#dynamic_page_keywrd_input').val() +
                    '</p></td><td><p>' + $('.dynamic_page_from_input').val() + '</p></td><td><p>' + $(
                        '.dynamic_page_to_input').val() + '</p></td><td><p>' + $('#dynamic_page_price_input')
                    .val() + '</p></td><td><p>' + $('#total').val() + '</p></td><td>  ' +
            ...
            $('#add_btn').click(function() {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $("#add_btn").html(
                            "<option>  {{ __('front.Loading ...') }}</option>");
                    ...
                    success: function(response) {
                        ...
                        $(".alert-success-message3").html(
                                '<P style="text-align:center">Thank you.</p>').hide()
        ...
        $("#first_page_keywrd_input").change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var first_date_from = new Date(response.keyword.date_from).toLocaleDateString(
                        "en-US");
            ...
            $.each(files, function(key, file) {
                ...
                reader.onload = function(e) {
                    ...
                    $html = "<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12 weyy' > <div" +
                        "class='formItemVendor'><a href='" + e.target.result +
                        "' class='Itemmm'><div class='sliderimgItem'><img  src='" + e.target.result +
                        "'><button " +
        ...
        function changeVideoPreview(e, k, v) {
            ...
            $.each(files, function(key, file) {
                ...
                reader.onload = function(e) {
                    ...
                    $html =
                        ' <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 weyy"> <div class="formItemVendor"> <div class="sliderimgItem"><video class="VedioPorUpload"  controls><source src="' +
                        e.target.result +
                        '" type="video/mp4"></video> <button type="button" class="Removee RemoveVideo RemoveProductImage" ><i class="far fa-trash-alt"></i> </button></div></div</div>   ';
