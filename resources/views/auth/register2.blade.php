 ...
 <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="registerForm">
                    <div class="row">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home1" role="tab">
                                                ...
                                                <span class=" d-sm-block">{{__('front.Register as User')}}</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#profile1" role="tab">
                                                
                                                <span class=" d-sm-block">{{__('front.Register as Vendor')}}</span>
                                            </a>
                                        </li>
                                                    ...
                                                    <div class="card ">
                                                        ...
                                                        <form id="msform" method="post" action="" novalidate="novalidate" enctype="multipart/form-data">
                                                            ...
                                                            <ul id="progressbar">
                                                                ...
                                                                <li id="payment"><span>تاكيد الحساب</span></li>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select id='country' name='country' class='form-control select2'>
                                                                                            <option value='Mr'>القاهره</option>
                                                                                            <option value='Mrs'>الغربيه</option>
                                                                                            <option value='Miss'>الاقصر </option>
                                                                                            <option value='Ms'>اسوان</option>
                                                                                        </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="form-card" id="TypeInputs">
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            
                                                                             <div class="chooseTypeConfirmation">
                                                                                    <p>من فضلك اختر طريقة ارسال كود التفعيل بالطريقه التى تناسبك</p>
                                                                                </div>
                                                                            <div class="TapCOnfirmation">
                                                                                <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                                                                    <li class="nav-item">
                                                                                        <a class="nav-link active" data-bs-toggle="tab" href="#Phone" role="tab">
                                                                                            ...
                                                                                            <span class=" d-sm-block">{{__('front.Phone Number')}}</span>
                                                                                        </a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a class="nav-link" data-bs-toggle="tab" href="#Email" role="tab">
                                                                                            
                                                                                            <span class=" d-sm-block">{{__('front.Email')}}</span>
                                                                                        </a>
                                                                                    </li>
                                                                                ...
                                                                                <div class="tab-content p-3 text-muted">
                                                                                    <div class="tab-pane active" id="Phone" role="tabpanel">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="input-group">
                                                                                                        ...
                                                                                                        <input type="text" id='' name='phone' class="form-control" placeholder=""  aria-describedby="basic-addon1">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                                <div class="butonSubmitCode">
                                                                                                    <button class="SubmitConCode" type="button" id="SendCode">ارسل الكود</button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="tab-pane" id="Email" role="tabpanel">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-12 col-md-12col-sm-12 col-xs-12">
                                                                                                <div class="form-group">
                                                                                                    <label class="fieldlabels">{{__('front.Email')}}</label>
                                                                                                    <input type="email" id='' name='shop_name' placeholder="" required />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                                <div class="butonSubmitCode">
                                                                                                    <button class="SubmitConCode" type="button" id="SendCodeEmail">ارسل الكود</button>
                                                                                                </div>
                                                                                            </div>
                                                                ...
                                                                <div class="" style="display: none" id="writeCode" >
                                                                    <div class="form-card">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12col-sm-12 col-xs-12">
                                                                            <div class="form-group">
                                                                                <label class="fieldlabels">اكتب الكود</label>
                                                                                <input type="text" id='' name='shop_name' placeholder="" required />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12col-sm-12 col-xs-12">
                                                                            <div class="form-group">
                                                                                <div class="ResendCode">
                                                                                    <a id="ResendCode" class="resendConfimCode"> ارسال الكود مجددا  </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 othercol">
                            <div class="rigjtcont">
...
name:name,
  ...
  cache: false,
                ...
                error: function(response) {
                    ...
                    $(".alert-success-message-vendor").css("display", "none");
                },
