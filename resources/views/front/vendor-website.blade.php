                                            ...
                                            <ul>
                                                ...
                                                @if (count($user->sliders) > 0)
                                                    @foreach ($user->sliders as $slide)
                                                        <li data-transition='random' data-slotamount='7'
                                                            data-masterspeed='1000' {{-- data-thumb='{{ Voyager::image($slide->image) }}'><img
                                                                src="{{ Voyager::image($slide->image) }}" alt="slide-img"
                                                                data-bgposition='left top' data-bgfit='cover'
                                                                data-bgrepeat='no-repeat' />
                                                            <div class="info">

                                                            </div> --}}
                                                            data-thumb='{{ asset("/users-details/sliders/$slide->image") }}'>
                                                            <img src="{{ asset("/users-details/sliders/$slide->image") }}"
                                                ...
                                                @else
                                                    <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                                                        data-thumb='assets/img/cladreximg/slide-img1.jpg'><img
                                                            src="{{ asset('frontUI/assets/img/slider3.png') }}"
                                                    ...
                                                    <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                                                        data-thumb='assets/img/cladreximg/slide-img2.jpg'><img
                                                            src="{{ asset('frontUI/assets/img/slider4.png') }}"
                                                            alt="slide-img" data-bgposition='left top' data-bgfit='cover'
                                                            data-bgrepeat='no-repeat' />
                                                        <div class="info">
                                                    ...
                                                    <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                                                        data-thumb='assets/img/cladreximg/slide-img3.jpg'><img
                                                            src="{{ asset('frontUI/assets/img/slider5.png') }}"
                                                            alt="slide-img" data-bgposition='left top' data-bgfit='cover'
                                                            data-bgrepeat='no-repeat' />
                                                        <div class="info">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="websiteVendor">
                                                                            <div class="productOwl PopuProd">
                                                                                <div class="title">
                                                                                    <h2> <span>{{ $pmc->cat }}</span>
                                                                                    </h2>
                                                                                </div>
                                                                                <div class="Products PopuProdtemsss">
                                                                                    <div
                                                                                        class="owl-carousel owl-theme prprprOwl">
                                                                                        @if ($pmc->products)
                                                                        ...
                                                                        @if (!empty(Auth::user()->certification))
                                                                            @foreach (Auth::user()->certification as $cer)
                                                                                <div
                                                                                    ...
                                                                                    <div class="certitem">
                                                                                        {{-- <a href="{{ Voyager::image($cer->image) }}"
                                                                                            class="itemcert">
                                                                                            <div class="imgaes">
                                                                                                <div
                                                                                                    class="imgesitem">
                                                                                                    <img
                                                                                                        src="{{ Voyager::image($cer->image) }}"> --}}
