                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-nd-12 col-sm-12 col-xs-12">
                                                    <div class="formItemVendor">
                                                        ...
                                                        <textarea placeholder="{{ __('front.Product Name EN') }}" id='product_name_en' name='product_name_en' required
                                                            class="TextInputt"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-nd-12 col-sm-12 col-xs-12">s
                                                    <div class="formItemVendor">
                                                        ...
                                                        <textarea placeholder=" {{ __('front.Product Name AR') }} " id='product_name_ar' name='product_name_ar' required
                                                            class="TextInputt"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="setingstaps">
                                                            ...
                                                            <div class="TapCOnfirmation bs-example">
                                                                ...
                                                                <div class="tab-content p-3 text-muted">
                                                                    <div class="tab-pane tabcontent-grids active" id="Phone"
                                                                        role="tabpanel">
                                                                        <div class="row">
                                                                    ...
                                                                    <div class="tab-pane tabcontent-grids" id="Email"
                                                                        role="tabpanel">
                                                                        <div class="row">
                                                                            <div
                                                                                class="col-lg-12 col-md-12col-sm-12 col-xs-12">
                                                                                <div class="setforms">
                                                                                    <div class="qoutstepform ">
                                                                ...
                                                                <div class="bs-example bs-example-tabs" role="tabpanel"
                                                                    data-example-id="togglable-tabs" style="display: none">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    ...
                                                                    <input type="number" step="0.01" id='min_price'
                                                                        name='min_price' class="inputvendor" required
                                                                        placeholder="">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="formItemVendor">
                                                                    ...
                                                                    <input type="number" step="0.01" id='max_price'
                                                                        name='max_price' class="inputvendor" required
                                                                        placeholder="">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="formItemVendor">
                                                                            <span>{{ __('front.Min') }}
                                                                                {{ __('front.Order') }}
                                                                                {{ __('front.Qty') }} </span>
                                                                            <input type="number" id='min_order'
                                                                                name='min_order' class="inputvendor"
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                        <div>
                                                            <span id='f_error'
                                                                style="display:none">{{ __('front.please select keyword,date from and date to') }}</span>
                                                                ...
                                                                <div class="col-lg-3 col-nd-3 col-sm-3 col-xs-12">
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        <input id='dynamic_page_keywrd_input'
                                                                            class="form-control  "
                                                                            list="dynamic_page_keywrd_list" type="text"
                                                                            value="" name='dynamic_page_keywrd' />
        ...
        function changePreview(e, k, v) {
            ...
            $.each(files, function(key, file) {
                ...
                reader.onload = function(e) {
                    ...
                    $html =
                        "<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12 weyy' > <div class='formItemVendor'><a href='" +
                        e.target.result + "' class='Itemmm'><div class='sliderimgItem'><img  src='" + e.target
                        .result + "'><button " +
            ...
            $.each(files, function(key, file) {
                ...
                reader.onload = function(e) {
                    ...
                    $html =
                        ...
                        e.target.result +
                        '" type="video/mp4"></video> <button type="button" class="Removee RemoveVideo RemoveSlide RemoveProductImage" ><i class="far fa-trash-alt"></i> </button></div> </div></div>  ';
