                                                                ...
                                                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                    <div class="imgesProduct">
                                                                        <div class="images">
                                                                            ...
                                                                            @else
                                                                                <img
                                                                                    src="{{ Voyager::image('default_product.png') }}">
                                                                            @endif
                                                                    ...
                                                                    <div class="produdetails">
                                                                       ...
                                                                       {{$keywordd->date_to }} --}}
                                                                                                @if (!($keywordd->date_to <= \Carbon\Carbon::now()->toDateString()))
                                                                                                    <img
                                                                                                        src="{{ asset('frontUI/assets/img/cladreximg/star.png') }}">
                                                                                                @else
                                                                                                    <img
                                                                                                        src="{{ asset('frontUI/assets/img/cladreximg/star_white.png') }}">
                                                                                                @endif
                                                                                            @endif
                                                                                        @endforeach
                                                                                    @else
                                                                            ...
                                                                            <div class="title">
                                                                                ...
                                                                                <a class="product_name"
                                                                                    href="{{ route('product', ['product_id' => $product->id, 'product_name' => $product->product_name_en ?? '']) }}"
                                                                                    target="_blank">
                                                                            ...
                                                                            <div class="fobMin">
                                                                                <ul>
                                                                                    <li>
                                                                                        <p>{{ __('front.FOB Price') }}:
                                                                                            <span
                                                                                                class="red">{{ $product->min_price }}-{{ $product->max_price }}
                                                                                            </span> <span
                                                                                                class="else"> /
                                                                            ...
                                                                            <div class="lidetaisl"
                                                                                ...
                                                                                <ul>
                                                                                    ...
                                                                                    <li>
                                                                                        <p>Usage : <span
                                                                                                class="sas">
                                                                                                Printing Paper </span></p>
                                                                                    </li>
                                                                                    <li>
                                                                                        <p>Coating Material : <span
                                                                                                class="sas"> None
                                                                                            </span></p>
                                                                                    </li>
                                                                                    <li>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <div class="addcart">
                                                                                ...
                                                                                <button type="button" class="btn_addcont"
                                                                                    data-id="{{ $product->id }}"
                                                                                    data-name="{{ $product->product_name }}"
                                                                                    data-user="{{ $product->user_id }}">
                                                                                    <i class="far fa-envelope"
                                                                                        aria-hidden="true"></i>
                                                                                    {{ __('front.Contact Now') }}
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                    ...
                    $.each(response.product_imgs, function(i, item) {
                        ...
                        if (item.type == 'image') {
                            ...
                            if (i == 0) {
                                ...
                                html += ' <a class="nav-link active" id="product-' + i +
                                    '-tab" data-bs-toggle="pill" href="#product-' + i +
                                    '" role="tab" aria-controls="product-' + i +
                                    '" aria-selected="true">' +
                                    '<img src="' + r +
                                    '" alt="" class="img-fluid mx-auto d-block rounded"></a>';


                                html2 += '<div class="tab-pane fade show active" id="product-' +
                                    i + '" role="tabpanel" aria-labelledby="product-' + i +
                                    '-tab"> <div> <img src="' + r +
                                    '" alt="" class="img-fluid mx-auto d-block"></div></div>';
                            } else {
                                html += ' <a class="nav-link " id="product-' + i +
                                    '-tab" data-bs-toggle="pill" href="#product-' + i +
                                    '" role="tab" aria-controls="product-' + i +
                                    '" aria-selected="true">' +
                                    '<img src="' + r +
                                    '" alt="" class="img-fluid mx-auto d-block rounded"></a>';
                                html2 += '<div class="tab-pane fade show " id="product-' + i +
                                    '" role="tabpanel" aria-labelledby="product-' + i +
                                    '-tab"> <div> <img src="' + r +
                                    '" alt="" class="img-fluid mx-auto d-block"></div></div>';
                            }
                        }
                        ...
                        if (item.type == 'video') {
                            ...
                            if (i == 0) {
                                html += ' <a class="nav-link  active " id="product-' + i +
                                    ...
                                    '" role="tab" aria-controls="product-' + i +
                                    '" aria-selected="true">' +
                                    '<video class="VedioPorUpload"  controls> <source src="' +
                                    r + '" type="video/mp4"> </video></a>';

                                html2 += '<div class="tab-pane fade show active" id="product-' +
                                    i + '" role="tabpanel" aria-labelledby="product-' + i +
                                    '-tab"> <div> <video class="VedioPorUpload"  controls> <source src="' +
                                    r + '" type="video/mp4"> </video></a></div></div>';
                            } else {
                                html += ' <a class="nav-link " id="product-' + i +
                                    '-tab" data-bs-toggle="pill" href="#product-' + i +
                                    '" role="tab" aria-controls="product-' + i +
